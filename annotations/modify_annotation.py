...
SAVE_PATH = '/home/super/mironov/mia/annotations'
DATASET = ['mnist', 'cifar10', 'food-101', 'caltech256', 'stfd_dogs'][4]

DATASET_PATH = os.path.join('/mnt/disk2/mironov/datasets', DATASET)
